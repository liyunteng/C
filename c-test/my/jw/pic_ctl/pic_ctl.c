...
static int
__pic_read_reg(uint8_t reg, uint8_t *v)
{
    int ret;
...
static int
__pic_write_reg(uint8_t reg, uint8_t v)
{
    int ret;
...
int
pic_set_led(uint8_t led, uint8_t sts, uint8_t freq)
{
    uint8_t v;
    uint8_t reg;
