...
static inline const char *disk_get_md_status(const struct disk_md_info *mi)
{
	const char *stat;
...
static inline void disk_get_warning_info(const char *dev, struct disk_warning_info *wi)
{
	FILE *fp;
...
static inlin const char *disk_get_raid_name(const struct us_disk *disk)
{
	int fd;
