...
staitc void
us_sess_release(struct us_session *sess)
{
...
static void
us_sess_on_io(EV_P_ ev_io *w, int r)
{
...
static void
us_sess_on_timeout(EV_P_ ev_timer *w, int r)
{
