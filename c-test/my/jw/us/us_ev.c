...
static void
us_shell_done(struct ev_loop *loop, ev_child *w, int r)
{
...
static void
us_shell_on_read(struct *ev_loop, ev_io *w, int r)
{
...
static void
us_shell_on_timeout(struct ev_loop *loop, ev_timer *w, int r)
{
...
void
us_shell_cmd_release(struct us_shell_cmd *scmd)
{
    struct ev_loop *loop = us_main_loop;
